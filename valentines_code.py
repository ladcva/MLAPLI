...
t.goto(0, -100)
t.color("red")
t.write("Gọi tớ yêu cậu là lệnh \"True\"", None, "center", "14pt")
t.goto(1, -125)
t.write("Nhưng True mà nằm ở trong string thì không so sánh đuợc", None, "center", "14pt")
t.goto(2, -150)
t.write("Cậu nhé !", None, "center", "14pt")
